    ...
    return (
      ...
      >
        <motion.div
          ...
          className={`flex flex-col relative -top-[25%] h-[400px] justify-center w-[70%] rounded-[7px] p-10 origin-top border-[1.5px] border-gray-800 `}
        >
         <div className={`w-full flex  justify-between items-center ${imageleft?"flex-row-reverse":""} `} >
              <div className='w-[47%] flex flex-col gap-[1rem] ' >
              ...
              <div className={`relative w-[47%] h-full rounded-lg overflow-hidden `}>
            <motion.div
